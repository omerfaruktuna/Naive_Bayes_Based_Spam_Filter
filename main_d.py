...
for i in range(len(all_features)):
    ...
    if all_features[i] in dictionary_legitimate:
        P_given_legitimate_all_features.append(
            (0 + a_legitimate_freq[dictionary_legitimate.index(all_features[i])]) / (learning_legitimate_class_word_size + 0))
    else:
        P_given_legitimate_all_features.append(1)
...
for i in range(len(all_features)):
    ...
    if all_features[i] in dictionary_spam:
        P_given_spam_all_features.append(
            (0 + a_spam_freq[dictionary_spam.index(all_features[i])]) / (learning_spam_class_word_size + 0))
    else:
        P_given_spam_all_features.append(1)
